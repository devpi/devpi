...
project = u'devpi'
copyright = u'2014, holger krekel and merlinux GmbH see http://merlinux.eu, cat picture CC-BY 2.0 licensed by "admiller" on flicker'
...
html_use_opensearch = 'http://devpi.net/'
