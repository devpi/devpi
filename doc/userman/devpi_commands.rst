...
::
    ...
    $ devpi getjson -h
    usage: /home/hpk/bin/devpi getjson [-h] [--version] [--debug] [-y]
                                       [--clientdir DIR]
                                       path
...
::
    ...
    $ devpi index -h
    usage: /home/hpk/bin/devpi index [-h] [--version] [--debug] [-y]
...
::
    ...
    $ devpi install -h
    usage: /home/hpk/bin/devpi install [-h] [--version] [--debug] [-y]
...
::
    ...
    $ devpi list -h
    usage: /home/hpk/bin/devpi list [-h] [--version] [--debug] [-y]
                                    [--clientdir DIR] [-f]
                                    [spec]
...
::
    ...
    $ devpi login -h
    usage: /home/hpk/bin/devpi login [-h] [--version] [--debug] [-y]
...
::
    ...
    $ devpi logoff -h
    usage: /home/hpk/bin/devpi logoff [-h] [--version] [--debug] [-y]
                                      [--clientdir DIR]
...
::
    ...
    $ devpi push -h
    usage: /home/hpk/bin/devpi push [-h] [--version] [--debug] [-y]
...
::
    ...
    $ devpi quickstart -h
    usage: /home/hpk/bin/devpi quickstart [-h] [--version] [--debug] [-y]
...
::
    ...
    $ devpi remove -h
    usage: /home/hpk/bin/devpi remove [-h] [--version] [--debug] [-y]
                                      [--clientdir DIR]
                                      spec
...
::
    ...
    $ devpi test -h
    usage: /home/hpk/bin/devpi test [-h] [--version] [--debug] [-y]
...
::
    ...
    $ devpi upload -h
    usage: /home/hpk/bin/devpi upload [-h] [--version] [--debug] [-y]
                                      [--clientdir DIR] [--ver SETVERSION]
                                      [--formats FORMATS] [--from-dir FROMDIR]
                                      [--only-latest] [--dry-run] [--with-docs]
                                      [--only-docs]
...
::
    ...
    $ devpi use -h
    usage: /home/hpk/bin/devpi use [-h] [--version] [--debug] [-y]
                                   [--clientdir DIR] [--venv VENV] [--urls] [-l]
                                   [--delete]
                                   [url]
...
::
    ...
    $ devpi user -h
    usage: /home/hpk/bin/devpi user [-h] [--version] [--debug] [-y]
