...
Let's verify that the project has been uploaded::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/dev/+f/74c/c6380e1045242/pysober-0.1.0.tar.gz
...
We can verify that we uploaded two versions of our release file::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/dev/+f/b48/c0a74a1d30841/pysober-0.2.0.tar.gz
   http://localhost:3141/emilie/dev/+f/74c/c6380e1045242/pysober-0.1.0.tar.gz
...
which in our case would restore the project::
   ...
   $ devpi list pysober   
   http://localhost:3141/emilie/dev/+f/0dc/a759c41a20435/pysober-0.2.0.tar.gz
...
version ``0.2.0`` to ``/emilie/prod``::
   ...
   $ devpi push  pysober==0.2.0 emilie/prod
      ...
      200 store_releasefile emilie/prod/+f/0dc/a759c41a20435/pysober-0.2.0.tar.gz
...
The list command now gives her a different picture::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/prod/+f/0dc/a759c41a20435/pysober-0.2.0.tar.gz
...
which leads to::
   ...
   $ devpi list pysober
   http://localhost:3141/sophie/dev/+f/172/9fd3aa257da67/pysober-0.2.1.tar.gz
   http://localhost:3141/emilie/prod/+f/0dc/a759c41a20435/pysober-0.2.0.tar.gz
...
And then performing the :term:`push`::
   ...
   $ devpi push pysober==0.2.0 sophie/dev
      ...
      200 store_releasefile sophie/dev/+f/0dc/a759c41a20435/pysober-0.2.0.tar.gz
...
Sophie would see the following::
   ...
   $ devpi list pysober
   http://localhost:3141/sophie/dev/+f/172/9fd3aa257da67/pysober-0.2.1.tar.gz
   http://localhost:3141/sophie/dev/+f/0dc/a759c41a20435/pysober-0.2.0.tar.gz
   http://localhost:3141/emilie/prod/+f/0dc/a759c41a20435/pysober-0.2.0.tar.gz
