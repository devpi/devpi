...
Let's verify that the project has been uploaded::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/dev/+f/e49/d4dce0655d648/pysober-0.1.0.tar.gz
...
We can verify that we uploaded two versions of our release file::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/dev/+f/5fd/7c9445efe334c/pysober-0.2.0.tar.gz
   http://localhost:3141/emilie/dev/+f/e49/d4dce0655d648/pysober-0.1.0.tar.gz
...
which in our case would restore the project::
   ...
   $ devpi list pysober   
   http://localhost:3141/emilie/dev/+f/c5f/8e28776757570/pysober-0.2.0.tar.gz
...
version ``0.2.0`` to ``/emilie/prod``::
   ...
   $ devpi push  pysober==0.2.0 emilie/prod
      ...
      200 store_releasefile emilie/prod/+f/c5f/8e28776757570/pysober-0.2.0.tar.gz
...
The list command now gives her a different picture::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/prod/+f/c5f/8e28776757570/pysober-0.2.0.tar.gz
...
which leads to::
   ...
   $ devpi list pysober
   http://localhost:3141/sophie/dev/+f/114/7312af71c1450/pysober-0.2.1.tar.gz
   http://localhost:3141/emilie/prod/+f/c5f/8e28776757570/pysober-0.2.0.tar.gz
...
And then performing the :term:`push`::
   ...
   $ devpi push pysober==0.2.0 sophie/dev
      ...
      200 store_releasefile sophie/dev/+f/c5f/8e28776757570/pysober-0.2.0.tar.gz
...
Sophie would see the following::
   ...
   $ devpi list pysober
   http://localhost:3141/sophie/dev/+f/114/7312af71c1450/pysober-0.2.1.tar.gz
   http://localhost:3141/sophie/dev/+f/c5f/8e28776757570/pysober-0.2.0.tar.gz
   http://localhost:3141/emilie/prod/+f/c5f/8e28776757570/pysober-0.2.0.tar.gz
