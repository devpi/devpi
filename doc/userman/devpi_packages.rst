...
Let's verify that the project has been uploaded::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/dev/+f/487/76a32b532410c/pysober-0.1.0.tar.gz
...
We can verify that we uploaded two versions of our release file::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/dev/+f/e3e/9ec225b2cb9d9/pysober-0.2.0.tar.gz
   http://localhost:3141/emilie/dev/+f/487/76a32b532410c/pysober-0.1.0.tar.gz
...
which in our case would restore the project::
   ...
   $ devpi list pysober   
   http://localhost:3141/emilie/dev/+f/f92/12e6fefdcc0e0/pysober-0.2.0.tar.gz
...
version ``0.2.0`` to ``/emilie/prod``::
   ...
   $ devpi push  pysober==0.2.0 emilie/prod
      ...
      200 store_releasefile emilie/prod/+f/f92/12e6fefdcc0e0/pysober-0.2.0.tar.gz
...
The list command now gives her a different picture::
   ...
   $ devpi list pysober
   http://localhost:3141/emilie/prod/+f/f92/12e6fefdcc0e0/pysober-0.2.0.tar.gz
...
which leads to::
   ...
   $ devpi list pysober
   http://localhost:3141/sophie/dev/+f/ded/a221696df1458/pysober-0.2.1.tar.gz
   http://localhost:3141/emilie/prod/+f/f92/12e6fefdcc0e0/pysober-0.2.0.tar.gz
...
And then performing the :term:`push`::
   ...
   $ devpi push pysober==0.2.0 sophie/dev
      ...
      200 store_releasefile sophie/dev/+f/f92/12e6fefdcc0e0/pysober-0.2.0.tar.gz
...
Sophie would see the following::
   ...
   $ devpi list pysober
   http://localhost:3141/sophie/dev/+f/ded/a221696df1458/pysober-0.2.1.tar.gz
   http://localhost:3141/sophie/dev/+f/f92/12e6fefdcc0e0/pysober-0.2.0.tar.gz
   http://localhost:3141/emilie/prod/+f/f92/12e6fefdcc0e0/pysober-0.2.0.tar.gz
