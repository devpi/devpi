...
and then re-install it with ``easy_install``::
    ...
    Writing /tmp/easy_install-R_HCz4/simplejson-3.3.0/setup.cfg
    Running simplejson-3.3.0/setup.py -q bdist_egg --dist-dir /tmp/easy_install-R_HCz4/simplejson-3.3.0/egg-dist-tmp-n4kKMs
...
At any time you can check the background server status with::
    ...
    $ devpi-server --status
    server is running with pid 14046

Or stop it::
    
    $ devpi-server --stop
    killed server pid=14046
...
(also after it has been stopped)::
    ...
    2013-08-13 16:16:37,796 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-1.6.tar.gz
    2013-08-13 16:16:37,796 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-1.5.tar.gz
    2013-08-13 16:16:37,797 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/2.4/s/simplejson/simplejson-1.5-py2.4.egg
    2013-08-13 16:16:37,797 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/2.4/s/simplejson/simplejson-1.4-py2.4.egg
    2013-08-13 16:16:37,797 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-1.4.tar.gz
    2013-08-13 16:16:37,798 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-1.3.tar.gz
    2013-08-13 16:16:37,798 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/2.4/s/simplejson/simplejson-1.3-py2.4.egg
    2013-08-13 16:16:37,798 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-1.1.tar.gz
    2013-08-13 16:16:37,799 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/2.4/s/simplejson/simplejson-1.1-py2.4.egg
    2013-08-13 16:16:37,799 [INFO ] devpi_server.filestore: replaced md5 info for root/pypi/f/https/pypi.python.org/packages/2.3/s/simplejson/simplejson-1.1-py2.3.egg
    devpi.localhost - - [13/Aug/2013 16:16:37] "GET /root/pypi/+simple/simplejson/ HTTP/1.1" 200 15983
    2013-08-13 16:16:37,898 [INFO ] devpi_server.filestore: cache-streaming: https://pypi.python.org/packages/source/s/simplejson/simplejson-3.3.0.tar.gz, target root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-3.3.0.tar.gz
    2013-08-13 16:16:37,898 [INFO ] devpi_server.filestore: starting file iteration: root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-3.3.0.tar.gz (size 67250)
    2013-08-13 16:16:38,012 [INFO ] devpi_server.filestore: finished getting remote 'https://pypi.python.org/packages/source/s/simplejson/simplejson-3.3.0.tar.gz'
    devpi.localhost - - [13/Aug/2013 16:16:38] "GET /root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-3.3.0.tar.gz HTTP/1.1" 200 67250
    devpi.localhost - - [13/Aug/2013 16:16:39] "GET /root/pypi/+simple/simplejson/ HTTP/1.1" 200 15983
    2013-08-13 16:16:39,313 [INFO ] devpi_server.filestore: starting file iteration: root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-3.3.0.tar.gz (size 67250)
    devpi.localhost - - [13/Aug/2013 16:16:39] "GET /root/pypi/f/https/pypi.python.org/packages/source/s/simplejson/simplejson-3.3.0.tar.gz HTTP/1.1" 200 67250
