...
def add_autocreate_users_options(parser, pluginmanager):
    parser.addoption(
        "--autocreate-users", action="store_true",
        default=False,
    ...
    # Additional options could be added here that take advantage of the new
    # user_created hook.
...
def addoptions(parser, pluginmanager):
    ...
    add_autocreate_users_options(
        parser.addgroup("autocreate users options"),
        pluginmanager)
